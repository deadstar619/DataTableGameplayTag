...
#include "K2Node_GetDataTableRowByTag.generated.h"
...
UCLASS()
class DATATABLEGAMEPLAYTAGNODES_API UK2Node_GetDataTableRowByTag : public UK2Node
{
	...
	/** Get the tag input pin */
	UEdGraphPin* GetTagPin() const;
